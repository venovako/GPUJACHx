#ifndef DEVICE_CODE_NOSORT_SOLVEV_HPP
#define DEVICE_CODE_NOSORT_SOLVEV_HPP

MYKERN __launch_bounds__(HYPJACL1_MAX_THREADS_PER_BLOCK, HYPJACL1_MIN_BLOCKS_PER_SM)
  dDefJacL1(const unsigned step)
{
...
MYKERN __launch_bounds__(HYPJACL1_MAX_THREADS_PER_BLOCK, HYPJACL1_MIN_BLOCKS_PER_SM)
  dHypJacL1(const unsigned step, const unsigned nplus)
{
  __shared__ double shMem[2048u];
