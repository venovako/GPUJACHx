...
extern void initSymbols(double *const G, double *const V, volatile unsigned Long *const cvg, const unsigned nRow, const unsigned nCol, const unsigned ldG, const unsigned ldV, const unsigned nSwp, const double alpha, const double beta, const double* &alpha_ptr, const double* &beta_ptr) throw();
