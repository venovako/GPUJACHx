...
FC=gfortran
ifdef NDEBUG
FOPTS=-O$(NDEBUG) -cpp -DNDEBUG -march=native -Wa,-q -fgcse-las -fgcse-sm -fipa-pta -ftree-loop-distribution -ftree-loop-im -ftree-loop-ivcanon -fivopts -fvect-cost-model=unlimited -fvariable-expansion-in-unroller -fopenmp -fstack-arrays -Wall -Warray-temporaries -Wcharacter-truncation -Wimplicit-procedure -Wfunction-elimination -Wrealloc-lhs-all
else # DEBUG
FOPTS=-Og -cpp -march=native -Wa,-q -fopenmp -fstack-arrays -fcheck=all -finit-derived -finit-local-zero -finit-real=snan -ffpe-trap=invalid,zero,overflow -Wall -Warray-temporaries -Wcharacter-truncation -Wimplicit-procedure -Wfunction-elimination -Wrealloc-lhs-all
endif # ?NDEBUG
HDF5=$(HOME)/hdf5
